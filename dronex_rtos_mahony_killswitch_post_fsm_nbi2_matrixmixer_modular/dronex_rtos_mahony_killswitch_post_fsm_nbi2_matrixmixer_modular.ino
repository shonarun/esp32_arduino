...
void setup() {
  ...
  // NEW: Spawn the Sensor Polling Task on Core 1 (Priority 3 - Highest)
  xTaskCreatePinnedToCore(Task_SensorRead, "SensorRead", 4096, NULL, 3, &SensorTask, 1);
  
  // Flight Control on Core 1 (Priority 2)
